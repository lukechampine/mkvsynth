...
static const yytype_int8 yyrhs[] =
{
      ...
      94,    39,    66,    40,    41,    70,    42,    -1,    26,    94,
      43,    71,    44,    -1,    25,    71,    44,    -1,    25,    44,
      -1,    44,    -1,    71,    44,    -1,    20,    39,    71,    40,
      69,    -1,    20,    39,    71,    40,    69,    21,    69,    -1,
      28,    71,    44,    -1,    -1,    67,    -1,    66,    45,    67,
      -1,    68,    94,    -1,    43,    68,    94,    -1,     3,    -1,
       4,    -1,     5,    -1,     6,    -1,    59,    -1,    41,    70,
      42,    -1,    59,    -1,    70,    59,    -1,    72,    -1,    74,
      -1,    74,    73,    72,    -1,    46,    -1,    11,    -1,    12,
      -1,    13,    -1,    14,    -1,    15,    -1,    16,    -1,    17,
      -1,    76,    -1,    76,    47,    74,    48,    75,    -1,    74,
      -1,    27,    47,    74,    -1,    77,    -1,    76,    29,    77,
      -1,    78,    -1,    77,    30,    78,    -1,    80,    -1,    78,
      79,    80,    -1,    31,    -1,    32,    -1,    82,    -1,    80,
      81,    82,    -1,    33,    -1,    34,    -1,    35,    -1,    36,
      -1,    84,    -1,    82,    83,    84,    -1,    49,    -1,    50,
      -1,    86,    -1,    84,    85,    86,    -1,    51,    -1,    52,
      -1,    53,    -1,    87,    -1,    86,    54,    87,    -1,    88,
      -1,    87,    19,    88,    -1,    89,    -1,    89,    18,    88,
      -1,    90,    -1,    90,    91,    -1,    93,    -1,    93,    55,
      93,    -1,    92,    -1,    91,    92,    -1,    94,    -1,    94,
      43,    94,    -1,    94,    -1,    50,    94,    -1,    56,    94,
      -1,     8,    -1,     7,    -1,    39,    71,    40,    -1
};
...
{
  "$end", "error", "$undefined", "NUM", "BOOL", "STRING", "CLIP",
  "CONSTANT", "IDENTIFIER", "ASSIGN", "BINOP", "ADDEQ", "SUBEQ", "MULEQ",
  "DIVEQ", "POWEQ", "MODEQ", "CHNEQ", "CHAIN", "CNCAT", "IF", "ELSE",
  "TERN", "FNCT", "FNDEF", "RETURN", "DEFAULT", "OTHER", "IMPORT", "LOR",
  "LAND", "EQ", "NE", "GT", "LT", "GE", "LE", "NEG", "IFX", "'('", "')'",
  "'{'", "'}'", "':'", "';'", "','", "'='", "'?'", "'|'", "'+'", "'-'",
  "'*'", "'/'", "'%'", "'^'", "'.'", "'!'", "$accept", "program", "stmt",
  "function_declaration", "default_stmt", "return_stmt", "expression_stmt",
  "selection_stmt", "import_stmt", "param_list", "param", "type", "block",
  "stmt_list", "expr", "assignment_expr", "assignment_operator",
  "ternary_expr", "ternary_end", "boolean_or_expr", "boolean_and_expr",
  "boolean_eq_expr", "eq_operator", "boolean_rel_expr", "rel_operator",
  "arithmetic_add_expr", "add_operator", "arithmetic_mul_expr",
  "mul_operator", "arithmetic_exp_expr", "concat_expr", "chain_expr",
  "function_expr", "fn_name_expr", "arg_list", "function_arg",
...
{
     -56,    10,   -56,   -56,   -56,   -35,    -2,    34,    -2,   128,
     128,   -56,    -2,    -2,   -56,   -56,   -56,   -56,   -56,   -56,
     -56,   -18,   -56,   143,   -16,    13,   -11,   109,   -34,    28,
      -7,    33,   -56,    35,    -2,     0,   -56,   128,    18,   -56,
      14,    22,    30,    37,   -56,   -56,   -56,   -56,   -56,   -56,
     -56,   -56,   -56,   -56,   -56,   128,   128,   128,   128,   -56,
     -56,   128,   -56,   -56,   -56,   -56,   128,   -56,   -56,   128,
     -56,   -56,   -56,   128,   128,   128,   128,    -2,   -56,    40,
     128,    51,    19,   -56,   128,   -56,   -56,   -56,    13,    44,
     -11,   109,   -34,    28,    -7,    33,   -56,   -56,   -56,    -2,
     -56,    20,   -56,   -56,   -56,   -56,   144,   -26,   -56,    -2,
      52,   114,   -56,    90,   -56,    74,    -2,    59,    19,   -56,
     -56,    55,   -56,   -56,   -56,    43,    20,   -56,    90,   -56,
     128,   -56,   -56,   -56,    81,   -56,   -56
};
...
static const yytype_int8 yypgoto[] =
{
     ...
     -15,     7,    -9,   -20,     2,    64,   -56,   -55,   -56,   -56,
      70,    72,   -56,    67,   -56,    66,   -56,    69,   -56,    78,
      65,   -43,   -56,   -56,   -56,    75,    82,    -5
};
...
{
      14,    38,    89,    41,    37,     3,     4,    44,    45,    40,
       2,    42,    43,    56,   117,    67,    68,     3,     4,   118,
      59,    60,   102,   103,   104,   105,    46,     3,     4,    79,
       5,    57,    96,    97,     6,     7,     8,    10,     9,    81,
       5,     3,     4,    58,     6,     7,     8,    74,     9,    10,
       3,     4,    75,    76,    11,    80,   122,    82,    83,    10,
      12,   113,   106,     5,    11,    84,    13,     6,     7,     8,
      12,     9,    79,    10,    85,   135,    13,    86,    39,    70,
      71,    72,    10,    99,    12,   131,   110,    11,     3,     4,
      13,   101,   111,    12,   112,   126,   120,     3,     4,    13,
     128,     5,   130,   129,   119,     6,     7,     8,   134,     9,
       5,   127,   124,   116,     6,     7,     8,   133,     9,    87,
      10,     3,     4,   136,   132,    11,    88,   124,    91,    10,
      90,    12,    92,   132,    11,     3,     4,    13,    93,    95,
      12,   121,    62,    63,    64,    65,    13,   102,   103,   104,
     105,    94,    98,    10,    47,    48,    49,    50,    51,    52,
      53,     0,   100,     0,    12,     0,     0,    10,     0,     0,
      13,     0,     0,     0,     0,     0,     0,     0,    12,     0,
       0,     0,     0,     0,    13,     0,     0,     0,     0,    54
};
...
{
       1,     6,    57,     8,    39,     7,     8,    12,    13,     7,
       0,     9,    10,    29,    40,    49,    50,     7,     8,    45,
      31,    32,     3,     4,     5,     6,    44,     7,     8,    34,
      20,    47,    75,    76,    24,    25,    26,    39,    28,    37,
      20,     7,     8,    30,    24,    25,    26,    54,    28,    39,
       7,     8,    19,    18,    44,    55,   111,    39,    44,    39,
      50,    41,    43,    20,    44,    43,    56,    24,    25,    26,
      50,    28,    77,    39,    44,   130,    56,    40,    44,    51,
      52,    53,    39,    43,    50,    42,    84,    44,     7,     8,
      56,    40,    48,    50,    99,    21,    44,     7,     8,    56,
      41,    20,    47,   118,   109,    24,    25,    26,   128,    28,
      20,   116,   113,   106,    24,    25,    26,   126,    28,    55,
      39,     7,     8,    42,   125,    44,    56,   128,    61,    39,
      58,    50,    66,   134,    44,     7,     8,    56,    69,    74,
      50,    27,    33,    34,    35,    36,    56,     3,     4,     5,
       6,    73,    77,    39,    11,    12,    13,    14,    15,    16,
      17,    -1,    80,    -1,    50,    -1,    -1,    39,    -1,    -1,
      56,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    50,    -1,
      -1,    -1,    -1,    -1,    56,    -1,    -1,    -1,    -1,    46
};
...
{
       0,    58,     0,     7,     8,    20,    24,    25,    26,    28,
      39,    44,    50,    56,    59,    60,    61,    62,    63,    64,
      65,    71,    72,    74,    76,    77,    78,    80,    82,    84,
      86,    87,    88,    89,    90,    93,    94,    39,    94,    44,
      71,    94,    71,    71,    94,    94,    44,    11,    12,    13,
      14,    15,    16,    17,    46,    73,    29,    47,    30,    31,
      32,    79,    33,    34,    35,    36,    81,    49,    50,    83,
      51,    52,    53,    85,    54,    19,    18,    91,    92,    94,
      55,    71,    39,    44,    43,    44,    40,    72,    77,    74,
      78,    80,    82,    84,    86,    87,    88,    88,    92,    43,
      93,    40,     3,     4,     5,     6,    43,    66,    67,    68,
      71,    48,    94,    41,    59,    69,    68,    40,    45,    94,
      44,    27,    74,    75,    59,    70,    21,    94,    41,    67,
      47,    42,    59,    69,    70,    74,    42
};
