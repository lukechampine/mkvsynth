del: delbrot/lex.yy.c delbrot/y.tab.c delbrot/delbrot.c delbrot/plugins.c
	@cc -lm -lpthread jarvis/bufferAllocation.c jarvis/frameControl.c jarvis/spawn.c delbrot/lex.yy.c delbrot/y.tab.c delbrot/delbrot.c delbrot/plugins.c filters/gradientVideoGenerate.c filters/writeRawFile.c -o del
